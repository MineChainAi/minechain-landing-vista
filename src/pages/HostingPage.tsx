  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Host your AI workstation, mining rig, or custom GPU cluster in our state-of-the-art data center, optimized for maximum uptime and performance." />
      </Helmet>
