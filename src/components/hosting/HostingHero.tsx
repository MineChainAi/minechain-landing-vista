    ...
    <section className="pt-32 pb-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6 inline-flex items-center px-3 py-1 bg-[#F97316]/10 border border-[#F97316]/20 rounded-full transform hover:scale-105 transition-transform duration-300">
          ...
          <p className="text-lg md:text-xl text-mine-silver mb-10 max-w-3xl mx-auto animate-fade-in" style={{animationDelay: "0.1s"}}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{animationDelay: "0.2s"}}>
            <Button 
              size="lg"
              className="bg-[#F97316] hover:bg-[#F97316]/90 text-white group transition-all duration-300"
      ...
      <div className="mt-16 max-w-6xl mx-auto px-4 animate-fade-in" style={{animationDelay: "0.3s"}}>
        <div className="relative rounded-lg overflow-hidden border border-[#1E293B] shadow-xl group transform transition-transform duration-500">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
            <div className="flex flex-wrap gap-4">
              <div className="bg-black/60 backdrop-blur-sm px-4 py-2 rounded-full transform hover:scale-105 transition-transform duration-300">
